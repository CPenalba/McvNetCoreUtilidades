...
namespace McvNetCoreUtilidades.Helpers
{
    public class HelperCryptography
    {
        //TENDREMOS UNA PROPIEDAD NUEVA PARA ALMACENAR EL SALT QUE HEMOS CREADO DINAMICAMENTE
            ...
            (string contenido, bool comparar)
        {
            if (comparar == false)
            {
                //CREAMOS UN NUEVO SALT PARA EL CIFRADO Y LO ALMACENAMOS EN LA PROPIEDAD
                Salt = GenerateSalt();
            }
            //EL SALT LO PODEMOS UTILIZAR EN MULTIPLES LUGARES AL INICIO, FINAL, CON INSERT
